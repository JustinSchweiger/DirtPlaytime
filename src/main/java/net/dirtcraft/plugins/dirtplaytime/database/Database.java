...
public class Database {
	...
	private static void createDataSource() {
		try {
			...
			ds.setJdbcUrl("jdbc:h2:" + DirtPlaytime.getPlugin().getDataFolder().getAbsolutePath() + "/data/dirtplaytime");
	...
	public static void initialiseDatabase() {
		InputStream inputStream = DirtPlaytime.getPlugin().getResource("dbsetup.sql");
